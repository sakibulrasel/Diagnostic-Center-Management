<%-- 
    Document   : accountantprofile
    Created on : Dec 17, 2018, 12:24:01 AM
    Author     : sakib
--%>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="card">
                                <img id="paitentimage" class="img-rounded img-fluid"
                                 src="resources/aimage/${sessionScope.acinfo.emailid}.jpg" height="550px"
                                 width="835px"/>
                                <div class="card-content">
                                    ...
                                    <div class="card-content-languages">
                                        <div class="card-content-languages-group">
                                            ...
                                            <div>
                                                <ul>
                                                    <li>${sessionScope.acinfo.emailid}
                                            ...
                                            <div>
                                                <ul>
                                                    <li>${sessionScope.acinfo.lname}</li>
                                            ...
                                            <div>
                                                <ul>
                                                    <li>${sessionScope.acinfo.gender}</li>
        ...
        =====================================================================-->
         <script>
                ...
                setTimeout(function () {
                    ...
                    toastr.success('Welcome ${sessionScope.UserLoggedIn}');

<%-- 
    ...
    Created on : Dec 12, 2018, 10:08:16 PM
    Author     : sakib
--%>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    ...
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="addpayment"> <i class="fa fa-plus"></i>  Generate Bill</a>  
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="bill in Billlist| filter:test" >
                                                    <td>{{bill.payid}}</td>
                                                    <td>{{bill.pid}}</td>
                                                    <td>{{bill.testid}}</td>
                                                    <td>{{bill.addid}}</td>
                                                    <td>{{bill.appointfees}}</td>
                                                    <td>{{bill.admissionfees}}</td>
                                                    <td>{{bill.testcost}}</td>
                                                    <td>{{bill.total}}</td>
                                                    <td>{{bill.status}}</td>
                                                <td>
                                                        <a href="totalreportView?getpayid={{bill.payid}}"><button id="editbuttons" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>

<%-- 
    ...
    Created on : Dec 25, 2018, 1:05:54 PM
    Author     : sakib
--%>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form:form class="col-sm-6" method="POST" action="reporttotalView" commandName="reportInputForm" ng-repeat="pp in Payment">

                                        


                                                    <form:hidden  class="form-control" value="{{pp.payid}}" path="payid"></form:hidden>


                                                <div class="reset-button">
                                                <form:button id="editbuttons" type="submit" 
                                                             class="btn">Receive Bill</form:button>

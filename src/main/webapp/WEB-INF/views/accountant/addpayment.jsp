    ...
    <body class="hold-transition sidebar-mini">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form:form class="col-sm-6" commandName="addPaymentObject1" action="addingpayment"
                                               enctype="multipart/form-data">
                                        
                                        <div class="form-group">
                                            <label>Patient Id</label>
                                            <form:input class="form-control" 
                                                        type="number" value="${appointinfo.pid}" path="pid" readonly="true"  required="true"></form:input>
                                            </div>
                                        
                                        <div class="form-group">
                                            <label>Appointment Id</label>
                                            <form:input class="form-control" 
                                                        type="number" value="${appointinfo.appointid}" path="appointid" readonly="true"  required="true"></form:input>
                                            </div>
                                        
                                        <div class="form-group">
                                            <label>Admission Id</label>
                                            <form:input class="form-control" 
                                                        type="number" value="${admissioninfo.addid}" path="addid" readonly="true"  required="true"></form:input>
                                            </div>
                                        
                                        <div class="form-group">
                                            <label>Test Id</label>
                                            <form:input class="form-control" 
                                                        type="number" value="${testinfo.presid}" path="testid" readonly="true"  required="true"></form:input>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <form:input class="form-control" 
                                                        type="number" value="${appointinfo.fees}" path="appointfees" readonly="true"  required="true"></form:input>
                                            </div>
                                        
                                        <div class="form-group">
                                            <label>Admission Fees</label>
                                            <form:input class="form-control" 
                                                        type="number" value="${admissioninfo.cost}" path="admissionfees" readonly="true"  required="true"></form:input>
                                            </div>
                                        
                                        <div class="form-group">
                                            <label>Test Fees</label>
                                            <form:input class="form-control" 
                                                        type="number" value="${testinfo.amount}" path="testcost" readonly="true"  required="true"></form:input>
                                            </div>
                                        
                                        <div class="form-group">
                                            <label>Total Cost</label>
                                            <form:input class="form-control" 
                                                        type="number" value="${(appointinfo.fees)+(admissioninfo.cost)+(testinfo.amount)}" path="total" readonly="true"  required="true"></form:input>
                                            </div>
                                        ...
                                        <div class="reset-button">
                                            <form:button id="editbuttons" type="submit" class="btn" name="Add">Generate Bill
                                            </form:button>
        ...
        <script>
                                            $(document).ready(function () {
                                                var date_input = $('input[name="paymentdate"]');

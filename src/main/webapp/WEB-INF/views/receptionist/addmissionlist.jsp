                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    ...
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="addaddmission"> <i class="fa fa-plus"></i> Make Admission</a>  
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="Add in Addmission| filter:test" >
                                                    <td><input type="radio" name="radioGroup">
                                                        <label>{{Add.addid}}</label>   
                                                    </td>
                                                    <td>{{Add.roomid}}</td>
                                                    <td>{{Add.roomtype}}</td>
                                                    <td>{{Add.pid}}</td>
                                                    <td>{{Add.pname}}</td>
                                                    <td>{{Add.addmissiondate}}</td>
                                                    <td>{{Add.numberofday}}</td>
                                                    <td>{{Add.cost}}</td>
                                                    <td>{{Add.status}}</td>

<%-- 
    Document   : printtestreport
    Created on : Dec 27, 2018, 12:14:10 PM
    Author     : sakib
--%>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form:form class="col-sm-6" method="POST" action="testreportView" commandName="reportInputForm">
                                        <div class="form-group">
                                            <label>Patient Id</label>
                                            <select class="form-control" ng-model="selectedPatient" ng-options="x.presid for x in Preslist"></select>
                                        </div>
                                        <form:hidden  class="form-control" value="{{selectedPatient.presid}}" path="pid"></form:hidden>

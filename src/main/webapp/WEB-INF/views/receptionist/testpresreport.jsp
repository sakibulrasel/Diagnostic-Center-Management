<%-- 
    Document   : testpresreport
    Created on : Dec 27, 2018, 11:28:58 AM
    Author     : sakib
--%>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form:form class="col-sm-6" method="POST" action="testpresreportView" commandName="reportInputForm">

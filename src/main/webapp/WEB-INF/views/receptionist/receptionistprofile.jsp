                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="card">
                                <img id="pharmachistimage" class="img-rounded img-fluid" 
                                 src="resources/rimage/${sessionScope.rinfo.emailid}.jpg" height="550px"
                                 width="835px"/>
                                <div class="card-content">
                                    <div class="card-content-member">
                                        <h4 class="m-t-0">${sessionScope.rinfo.fname}</h4>
                                        <p class="m-0"><i class="pe-7s-map-marker"></i>${sessionScope.rinfo.address}</p>
                                    </div>
                                    <div class="card-content-languages">
                                        <div class="card-content-languages-group">
                                            ...
                                            <div>
                                                <ul>
                                                    <li>${sessionScope.rinfo.lname}</li>
                                            ...
                                            <div>
                                                <ul>
                                                    <li>${sessionScope.rinfo.gender}</li>

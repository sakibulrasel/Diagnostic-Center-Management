...
<html lang="en">
    ...
    <head>
        ...
        <script>
            var a = ${addmissionlist};
            var r =${roomlist};
            var p =${patientlist};
            
            console.log(r);
            angular.module('myapp', []).controller('AddmissionController',
                    function ($scope) {
                        $scope.Addmission = a;
                        $scope.Room = r;
                         $scope.Patient = p;
    ...
    <body class="hold-transition sidebar-mini" ng-app="myapp"
          ng-controller="AddmissionController">
        <!-- Site wrapper -->
        <div class="wrapper">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-primary" href="addmissionlist"> <i class="fa fa-list"></i>  Admission List</a>  
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form:form class="col-sm-6" name="addAddmissionObject"
                                               modelAttribute="addAddmissionObject1" action="addmissionadd"
                                               method="post">
                                        <c:if test="${!check}">
                                            <div class="form-group">
                                                <label>Admission Id</label>
                                                <form:input class="form-control" readonly="true"
                                                            type="number" path="addid" required="true"></form:input>
                                                </div>
                                        </c:if>
                                        <div class="form-group">
                                            <label>Bed Number</label>
                                            <select class="form-control" ng-model="selectedRoom" ng-options="x.roomnumber for x in Room"></select>
                                        </div>
                                        <form:hidden  class="form-control" value="{{selectedRoom.roomid}}" path="roomid"></form:hidden>

                                        <form:hidden  class="form-control" value="Available" path="status"></form:hidden>
                                        
                                        <div class="form-group">
                                            <label>Bed Type</label>
                                            <form:input class="form-control" Placeholder="Addmission Date"
                                                        type="text" value="{{selectedRoom.roomtype}}" path="roomtype" required="true"></form:input>
                                            </div>
                                        
                                        
                                        <div class="form-group">
                                            <label>Patient Id</label>
                                            <select class="form-control" ng-model="selectedPatient" ng-options="x.pid for x in Patient"></select>
                                        </div>
                                        <form:hidden  class="form-control" value="{{selectedPatient.pid}}" path="pid"></form:hidden>

                                        <div class="form-group">
                                            <label>Patient Name</label>
                                            <form:input class="form-control" Placeholder="Patient Name"
                                                        type="text" value="{{selectedPatient.fname}}" path="pname" ></form:input>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <form:input class="form-control" Placeholder="Addmission Date"
                                                        type="text" path="addmissiondate" required="true"></form:input>
                                            </div>
                                            <div class="form-group">
                                                <label>Number of Day</label>
                                            <form:input class="form-control" Placeholder="Number of day"
                                                        type="number" path="numberofday" required="true"></form:input>
                                            </div>
                                        <div class="form-group">
                                                <label>Bed Fees</label>
                                            <form:input class="form-control" Placeholder="Bed Cost"
                                                        type="number" value="{{selectedRoom.roomcost}}" path="cost" ></form:input>
                                            </div>
        ...
        <script>
                                            $(document).ready(function () {
                                                var date_input = $('input[name="addmissiondate"]');

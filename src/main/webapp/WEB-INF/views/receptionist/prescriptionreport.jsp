<%-- 
    ...
    Created on : Dec 26, 2018, 11:31:51 PM
    Author     : sakib
--%>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form:form class="col-sm-6" method="POST" action="presreportView" commandName="reportInputForm">
                                        <div class="form-group">
                                            <label>Patient Id</label>
                                            <select class="form-control" ng-model="selectedPatient" ng-options="x.pid for x in Preslist"></select>
                                        </div>
                                        <form:hidden  class="form-control" value="{{selectedPatient.pid}}" path="pid"></form:hidden>

                                           <form:hidden  class="form-control" value="{{selectedPatient.presid}}" path="presid"></form:hidden>
 
                                        
                                            <div class="reset-button">
                                                <form:button id="editbuttons" type="submit" 
                                                             class="btn">Search</form:button>

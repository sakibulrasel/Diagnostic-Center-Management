                    ...
                    <div class="tbl">
                        <div class="tbl-row">
                            ...
                            <div class="tbl-cell hdr-menu">
                                ...
                                <ul class="menu">
                                    <li>
                                        <a id="menu-home" href="patientprofile" class="mdl-button mdl-js-button mdl-js-ripple-effect">Home <i class="fa fa-chevron-down"></i></a>
        ...
        <div class="page-ttl">
            <div class="layer-stretch">
                <div class="page-ttl-container">
                    <h1>Doctors</h1>
                    <p><a href="patientprofile">Home</a> &#8594; <span>Doctors</span></p>
                </div>
            </div>

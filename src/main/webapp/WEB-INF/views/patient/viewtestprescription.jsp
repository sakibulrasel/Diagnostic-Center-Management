...
<html lang="en">
    ...
    <head>
        ...
        <script>
            ...
            console.log(tpres);
            angular.module('testApp', []).controller('testprescriptionController',
                    function ($scope) {
    ...
    <body class="hold-transition sidebar-mini" ng-app="testApp" ng-controller="testprescriptionController" >
        <!-- Site wrapper -->
        <div class="wrapper">

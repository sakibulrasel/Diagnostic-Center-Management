<%-- 
    ...
    Created on : Dec 16, 2018, 3:53:15 PM
    Author     : sakib
--%>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="pres in prescriptionangularobject" >
                                                    <td><input type="radio" name="radioGroup">
                                                        <label>{{pres.presid}}</label>   
                                                    </td>
                                                    <td>{{pres.pid}}</td>
                                                    <td>{{pres.doctorid}}</td>
                                                    <td>{{pres.presdate}}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="editingprescription?getpid={{pres.presid}}"><button id="editbuttons"
                                                                                                                        type="submit" class="btn"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
                                                        <a
                                                            href="removingprescription/{{pres.presid}}"><button  id="removebuttons"

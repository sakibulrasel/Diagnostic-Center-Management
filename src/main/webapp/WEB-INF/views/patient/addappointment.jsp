                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-primary" href="showappointment"> <i class="fa fa-list"></i>  Appionment List</a>  
                                    </div>
                                </div>
                                <div class="panel-body">

                                    <form:form class="col-sm-6" commandName="newAppointmentsObject" action="appointmentadd"
                                               enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Appointment Id</label>
                                            <form:input class="form-control" Placeholder="Appointment Id"
                                                        type="text" path="appointid" readonly="true"  required="true"></form:input>
                                            </div>
                                            <div class="form-group">
                                                <label>Patient Id</label>
                                            <form:input class="form-control" Placeholder="Patient Id"
                                                      readonly="true"  type="text" path="pid" value="${patientinfo.pid}" required="true"></form:input>
                                            </div>
                                            ...
                                            <form:input class="form-control" Placeholder="Doctor Id"
                                                        type="text" readonly="true" path="doctorid" value="${doctorinfo.doctorid}" required="true"></form:input>
                                            </div>
                                        
                                        <div class="form-group">
                                                <label>Department Name</label>
                                            <form:input class="form-control" Placeholder="Doctor Id"
                                                        type="text" readonly="true" path="deptname" value="${doctorinfo.deptname}" required="true"></form:input>
                                            </div>

                                            <div class="form-group">
                                                <label>Appiontment date</label>
                                            <form:input class="form-control"
                                                        Placeholder="Appointment Date" type="text" path="appointdate" name="pdate" required="true"></form:input>
                                            </div>


                                            <div class="form-group">
                                                <label>Problem</label><br>
                                            <form:textarea class="form-control" path="problem" id="exampleTextarea" rows="3"></form:textarea>
                                            </div>

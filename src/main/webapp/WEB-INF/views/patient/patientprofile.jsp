                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="image pull-left">
                            <img id="paitentimage" class="img-rounded img-fluid"
                                 src="resources/pimage/${sessionScope.patientinfo.pid}.jpg" height="60px"
                                 width="40px"/>
                        </div>
                        <div class="info">
                            <h4>Welcome</h4>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        ...
                        <small>
                            <c:if test="${avl}">
                                <small>Appointment Process Successfull</small>
                            </c:if>
                                <c:if test="${!avl}">
                                    <small>Appointment Process Failed because The doctor your want to appoint is not available or you may already <br> have appointment with this doctor.</small>
                            </c:if>
                        </small>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <div class="card">
                                <img id="paitentimage" class="img-rounded img-fluid"
                                     src="resources/pimage/${sessionScope.patientinfo.pid}.jpg" height="550px"
                                     width="835px"/>
                                <div class="card-content">
                                    <div class="card-content-member">
                                        <h4 class="m-t-0">${sessionScope.patientinfo.fname}</h4>
                                        <p class="m-0"><i class="pe-7s-map-marker"></i>${sessionScope.patientinfo.address}</p>
                                    </div>
                                    <div class="card-content-languages">
                                        <div class="card-content-languages-group">
                                            ...
                                            <div>
                                                <ul>
                                                    <li>${sessionScope.patientinfo.emailid}
                                        ...
                                        <div class="card-content-languages-group">
                                            ...
                                            <div>
                                                <ul>
                                                    <li>${sessionScope.patientinfo.bloodgroup}</li>
                                        ...
                                        <div class="card-content-languages-group">
                                            ...
                                            <div>
                                                <ul>
                                                    <li>${sessionScope.patientinfo.age}</li>
                                        ...
                                        <div class="card-content-languages-group">
                                            ...
                                            <div>
                                                <ul>
                                                    <li>${sessionScope.patientinfo.mobile}</li>

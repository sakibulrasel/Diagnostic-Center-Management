                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="btn-group"> 
                                <a class="btn btn-primary" href="medicinelist"> <i class="fa fa-list"></i>  Medicine List</a>  
                            </div>
                        </div>
                        <div class="panel-body">
                         
                            <form:form class="col-sm-6" commandName="newMedecineObject" action="medecineadd"
                                   enctype="multipart/form-data">
                                <c:if test="${!check}">
                                <div class="form-group">
                                    <label>Medicine Id</label>
                                    <form:input class="form-control" Placeholder="Medecine Id"
                                                type="text" path="listid" required="true"></form:input>
                                </div>
                                </c:if>
                                
                                <div class="form-group">
                                    <label>Medicine Type</label>
                                    <select class="form-control" ng-model="selectedType" ng-options="x.typename for x in tylist"></select>
                                </div>
                                <form:hidden  class="form-control" value="{{selectedType.typeid}}" path="typeid"></form:hidden>
                                
                                <div class="form-group">
                                    <label>Medicine Group</label>
                                    <select class="form-control" ng-model="selectedGroup" ng-options="x.groupname for x in grlist"></select>
                                </div>
                                <form:hidden  class="form-control" value="{{selectedGroup.groupid}}" path="groupid"></form:hidden>
                                
                                <div class="form-group">
                                    <label>Medicine Name</label>
                                    <form:input class="form-control" Placeholder="Medecine Name"
                                                type="text" path="medecinename" required="true"></form:input>
                                </div>

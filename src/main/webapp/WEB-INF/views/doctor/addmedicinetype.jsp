                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="btn-group"> 
                                <a class="btn btn-primary" href="medicinetypelist"> <i class="fa fa-list"></i>  Medicine Type List</a>  
                            </div>
                        </div>
                        <div class="panel-body">
                         
                            <form:form class="col-sm-6" name="addMedecinetypeObject"
                                       modelAttribute="addMedecinetypeObject1" action="addingmedecinetype"
                                       method="post">
                                <c:if test="${!check}">
                                <div class="form-group">
                                    <label>Type Id</label>
                                    <form:input class="form-control"
                                                Placeholder="Type Id" readonly="true" type="number" path="typeid" required="true"></form:input>
                                </div>
                                </c:if>
                                ...
                                <div class="form-group">
                                    ...
                                    <form:input class="form-control"
                                                Placeholder="Type Name" type="text" path="typename" required="true"></form:input>
                                </div>
                                <div class="form-group">
                                    <label>Description</label>
                                    <form:input class="form-control"
                                                Placeholder="Type Description" type="text" path="description" required="true"></form:input>
                                </div>
                                
                                  <c:if test="${check}">
                                  <div class="reset-button">
                                      <form:button id="editbuttons" type="submit" name="Addmedecinetype"
                                             class="btn">Save</form:button>
                                  </c:if>
                                             <c:if test="${!check}">
                                  <div class="reset-button">
                                      <form:button id="editbuttons" type="submit" name="EditMedecinetype"

...
<html lang="en">
    ...
    <body class="hold-transition sidebar-mini" ng-app="myapp" ng-controller="MedecinegroupController">
        <!-- Site wrapper -->
        <div class="wrapper">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="addmedecinegroup"> <i class="fa fa-plus"></i>  Add Medicine Group</a>  
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive" >
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="mgroup in Medecinegroup | filter:test">
                                                    <td><input type="radio" name="radioGroup">
                                                        <label>{{mgroup.groupid}}</label>   
                                                    </td>


                                                    <td>{{mgroup.groupname}}</td>
                                                    <td>{{mgroup.groupdescription}}</td>
                                                    <td>
                                                        <a href="editmedecinegroupbutton?getdeptid={{mgroup.groupid}}"><button id="editbuttons" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
                                                        <a href="removemedecinegroup/{{mgroup.groupid}}"><button class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                    </td>
                                                </tr>

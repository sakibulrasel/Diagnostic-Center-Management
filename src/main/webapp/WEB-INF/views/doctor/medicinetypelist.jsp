...
<html lang="en">
    ...
    <head>
        ...
        <script>
            var medt = ${medecinetypemodelobject};
            console.log(medt);
            angular.module('myapp', []).controller('MedecinetypeController',
                    function ($scope) {
                        $scope.Medecinetype = medt;
                    });
        </script>
    </head>
    <body class="hold-transition sidebar-mini" ng-app="myapp" ng-controller="MedecinetypeController">
        <!-- Site wrapper -->
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        ...
                        <h1>Medicine Type</h1>
                        <small>Medicine Type list</small>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="addmedecinetype"> <i class="fa fa-plus"></i>  Add Medicine Type</a>  
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive" >
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="mtype in Medecinetype | filter:test">
                                                    <td><input type="radio" name="radioGroup">
                                                        <label>{{mtype.typeid}}</label>   
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="editmedecinetypebutton?getdeptid={{mtype.typeid}}"><button id="editbuttons" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
                                                        <a href="removemedecinetype/{{mtype.typeid}}"><button class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                    </td>
                                                </tr>

                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="addtestprescription"> <i class="fa fa-plus"></i>  Add Test Prescription</a>  
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive" >
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="t in Testpres|filter:test">
                                                    <td><input type="radio" name="radioGroup">
                                                        <label>{{t.presid}}</label>   
                                                    </td>
                                                   ...
                                                   <td>{{t.amount}}</td>
                                                    <td>
                                                        <a href="edittestprescriptionbutton?getpresid={{t.presid}}"><button id="editbuttons" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
                                                        <a href="removetestprescription/{{t.presid}}"><button class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                    </td>
                                                </tr>

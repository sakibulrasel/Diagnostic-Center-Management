                ...
                <section class="content">
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <div class="card">
                                <img id="doctorimage" class="img-rounded img-fluid"
                                 src="resources/dimage/${sessionScope.docinfo.doctorid}.jpg" height="550px"
                                 width="835px"/>
                                <div class="card-content">
                                    <div class="card-content-member">
                                        <h4 class="m-t-0">${sessionScope.docinfo.fname}</h4>
                                        <p class="m-0"><i class="pe-7s-map-marker"></i>${sessionScope.docinfo.address}</p>
                                    </div>
                                    <div class="card-content-languages">
                                        <div class="card-content-languages-group">
                                            ...
                                            <div>
                                                <ul>
                                                    <li>${sessionScope.docinfo.emailid}
                                        ...
                                        <div class="card-content-languages-group">
                                            ...
                                            <div>
                                                <ul>
                                                    <li>${sessionScope.docinfo.deptname}</li>
                                            ...
                                            <div>
                                                <ul>
                                                    <li>${sessionScope.docinfo.age}</li>
                                            ...
                                            <div>
                                                <ul>
                                                    <li>${sessionScope.docinfo.experience}</li>

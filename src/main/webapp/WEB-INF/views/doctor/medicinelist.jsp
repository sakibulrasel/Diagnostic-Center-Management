...
<html lang="en">
    ...
    <head>
        ...
        <script>
            var mlist = ${medecinelist};
            var glist = ${grouplist};
            var tlist = ${typelist};

            angular.module('myApp', []).controller('MedecineController',
                    function ($scope) {
                        $scope.medecineangularobject = mlist;
                        $scope.grlist = glist;
                        $scope.tylist = tlist;
    ...
    <body class="hold-transition sidebar-mini"  ng-app="myApp" ng-controller="MedecineController" >
        <!-- Site wrapper -->
        <div class="wrapper">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="addmedicine"> <i class="fa fa-plus"></i>  Add Medicine</a>  
                                    </div>
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <thead class="success">
                                                <tr>
                                                    ...
                                                    <th>Medicine Group Id</th>
                                                    <th>Medicine Name</th>
                                                    <th>Update</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr ng-repeat="medicine in medecineangularobject|filter:test">
                                                    <td><input type="radio" name="radioGroup">
                                                        <label>{{medicine.listid}}</label>   
                                                    </td>


                                                    <td>{{medicine.typeid}}</td>
                                                    <td>{{medicine.groupid}}</td>
                                                    <td>{{medicine.medecinename}}</td>
                                                    <td>
                                                        <a href="editingmedecine?getpid={{medicine.listid}}"><button id="editbuttons" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
                                                        <a href="removingmedecine/{{medicine.listid}}"><button class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                    </td>
                                                </tr>

                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="addtestreport"> <i class="fa fa-plus"></i>  Add Test Report</a>  
                                    </div>
                                            ...
                                            <tbody>
                                                <tr ng-repeat="t in Testreport| filter:test">
                                                    ...
                                                    <td><img id="testimage" class="img-rounded img-fluid"
                                                             ...
                                                             width="60px"/></td>
                                                    <td>
                                                        <a href="edittestreportbutton?getreportid={{t.reportid}}"><button id="editbuttons" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
                                                        <a href="removetestreport/{{t.reportid}}"><button class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                    </td>
                                                </tr>

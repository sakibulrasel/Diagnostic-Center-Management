                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="addpharmacist"> <i class="fa fa-plus"></i> Add Laboratorist
                                        </a>  
                                    </div>        
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive" >
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="phr in Pharmacist">  
                                                    <td>
                                                        <input type="radio" name="radioGroup">
                                                        <label>{{phr.phid}}</label>   
                                                    </td>
                                                    <td><img id="pharmacistimage" class="img-rounded img-fluid"
                                                             src="resources/phimage/{{phr.emailid}}.jpg" height="50px"
                                                             width="60px"/></td>
                                                    <td>{{phr.fname}}</td>
                                                    <td>{{phr.lname}}</td>
                                                    <td>{{phr.emailid}}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="editpharmacistbutton?getphid={{phr.phid}}"><button id="editbuttons" type="submit"><i class="fa fa-pencil"></i></button></a>
                                                        <a href="removepharmacist/{{phr.phid}}"><button  id="removebuttons" type="button" class="btn"><i class="fa fa-trash-o"></i></button></a>

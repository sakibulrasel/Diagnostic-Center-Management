                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="adddoctor"> <i class="fa fa-plus"></i> Add Doctor
                                        </a>  
                                    </div>        
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive" >
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="Doc in Doctor| filter:test">  
                                                    <td>
                                                        <input type="radio" name="radioGroup">
                                                        <label>{{Doc.doctorid}}</label>   
                                                    </td>
                                                    <td><img id="doctorimage" class="img-rounded img-fluid"
                                                             src="resources/dimage/{{Doc.doctorid}}.jpg" height="50px"
                                                             width="60px"/></td>
                                                    <td>{{Doc.fname}}</td>
                                                    <td>{{Doc.lname}}</td>
                                                    <td>{{Doc.emailid}}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="editdoctorbutton?getdoctorid={{Doc.doctorid}}"><button id="editbuttons" type="submit"><i class="fa fa-pencil"></i></button></a>
                                                        <a href="removedoctor/{{Doc.doctorid}}"><button  id="removebuttons" type="button" class="btn"><i class="fa fa-trash-o"></i></button></a>

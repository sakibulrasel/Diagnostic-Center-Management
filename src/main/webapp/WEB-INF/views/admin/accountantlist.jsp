                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="addaccountant"> <i class="fa fa-plus"></i> Add Accountant
                                        </a>  
                                    </div>        
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive" >
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="ac in Accountant| filter:test">  
                                                    <td>
                                                        <input type="radio" name="radioGroup">
                                                        <label>{{ac.aid}}</label>   
                                                    </td>
                                                    <td><img id="accountantimage" class="img-rounded img-fluid"
                                                             src="resources/aimage/{{ac.emailid}}.jpg" height="50px"
                                                             width="60px"/></td>
                                                    <td>{{ac.fname}}</td>
                                                    <td>{{ac.lname}}</td>
                                                    <td>{{ac.emailid}}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="editaccountantbutton?getaid={{ac.aid}}"><button id="editbuttons" type="submit"><i class="fa fa-pencil"></i></button></a>
                                                        <a href="removeaccountant/{{ac.aid}}"><button  id="removebuttons" type="button" class="btn"><i class="fa fa-trash-o"></i></button></a>

...
#editbuttons:HOVER {
	...
	background: linear-gradient(to bottom, #9ccc65 50%, #8bc34a 50%);
        ...
        <script>
            ...
            console.log(ttype);
            angular.module('myapp', []).controller('TesttypeController',
                    function ($scope) {
                        $scope.Testtype = ttype;
                    });
        </script>
    </head>
    <body class="hold-transition sidebar-mini" ng-app="myapp" ng-controller="TesttypeController">
        <!-- Site wrapper -->
        <div class="wrapper">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="addtesttype"> <i class="fa fa-plus"></i>  Add Test Type</a>  
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive" >
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="mtype in Testtype| filter:test">
                                                    ...
                                                    <td>
                                                        <a href="edittesttypebutton?getdeptid={{mtype.typeid}}"><button id="editbuttons" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
                                                        <a href="removetesttype/{{mtype.typeid}}"><button class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                    </td>
                                                </tr>

...
<html lang="en">
    ...
    <head>
        ...
        <script>
            ...
            console.log(dept);
            angular.module('myapp', []).controller('DepartmentController',
                    function ($scope) {
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-primary" href="departmentlist"> <i class="fa fa-list"></i>  Department List</a>  
                                    </div>
                                </div>
                                <div class="panel-body">

                                    <form:form class="col-sm-6" name="addDepartmentObject"
                                               modelAttribute="addDepartmentObject1" action="addingdepartment"
                                               method="post" >
                                        <div class="form-group">
                                            ...
                                            <form:textarea class="form-control" path="description" id="exampleTextarea" rows="3"></form:textarea>
                                            </div>
                                            <div class="form-check">
                                                <label>Status</label><br>
                                                <label class="radio-inline">
                                                <form:radiobutton path="status" value="Active" checked="checked" name="abc"/>Active</label>
                                            <label class="radio-inline"><form:radiobutton path="status" value="Inctive" name="abc"/>Inctive</label>
                                        </div>                                       

                                        <div class="reset-button">
                                            <a href="#" class="btn btn-warning">Reset</a>
                                            <form:button id="editbuttons" type="submit" name="Adddepartment"

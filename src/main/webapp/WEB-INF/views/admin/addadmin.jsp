<%-- 
    Document   : addadmin
    Created on : Dec 26, 2018, 3:43:34 PM
    Author     : sakib
--%>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-primary" href="users"> <i class="fa fa-list"></i>  Admin List </a>  
                                    </div>
                                </div>
                                <div class="panel-body">

                                    <form:form class="col-sm-12" modelAttribute="urm" action="reguser" enctype="multipart/form-data">
                                        
                                        <div class="col-sm-6 form-group">
                                            <label>User Name</label>
                                            <form:input class="form-control" Placeholder="User Name" type="text" path="username" required="true"></form:input>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Password</label>
                                            <form:input class="form-control" Placeholder="Password" type="password" path="password" required="true"></form:input>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Phone Number</label>
                                            <form:input class="form-control"
                                                        Placeholder="Phone Number" type="text" path="phone" required="true"></form:input>
                                            </div>
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <div class="col-sm-12 reset-button">
                                                ...
                                                <form:button id="editdoctorbutton" type="submit" 

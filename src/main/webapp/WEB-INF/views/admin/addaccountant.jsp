<%-- 
    Document   : addpharmacist
    Created on : Dec 16, 2018, 11:27:52 PM
    Author     : sakib
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <script>
            var acc = ${accountantmodelobject};
           

            console.log(acc);

            angular.module('myApp', []).controller('AccountantController',
                    function ($scope) {
                        $scope.Accountant = acc;
                        
                        console.log($scope.Accountant);
                    });
        </script>
        <style type="text/css">
    ...
    <body class="hold-transition sidebar-mini" ng-app="myApp" ng-controller="AccountantController">        
        <!-- Site wrapper -->
        <div class="wrapper">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-primary" href="accountantlist"> <i class="fa fa-list"></i>  Accountant List </a>  
                                    </div>
                                </div>
                                <div class="panel-body">

                                    <form:form class="col-sm-12" name="addAccountantObject"
                                               modelAttribute="addAccountantObject1" action="addingaccountant"
                                               method="post" enctype="multipart/form-data">
                                        
                                        <c:if test="${!check}">
                                            <div class="col-sm-6 form-group">
                                                <label>Accountant Id</label>
                                                <form:input class="form-control"  type="number" readonly="true"  path="aid" required="true"></form:input>
                                                </div>
                                        </c:if>
                                        <div class="col-sm-6 form-group">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <c:if test="${check}">
                                                <form:button id="editaccountantbutton" type="submit" name="Addaccountant"
                                                             class="btn">Save</form:button>
                                            </c:if>
                                            <c:if test="${!check}">
                                                <form:button id="editaccountantbutton" type="submit" name="EditAccountant"

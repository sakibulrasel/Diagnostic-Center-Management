                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-primary" href="receptionistlist"> <i class="fa fa-list"></i>  Receptionist List </a>  
                                    </div>
                                </div>
                                <div class="panel-body">

                                    <form:form class="col-sm-12" name="addReceptionistObject"
                                               modelAttribute="addReceptionistObject1" action="addingreceptionist"
                                               method="post" enctype="multipart/form-data">
                                        
                                        <c:if test="${!check}">
                                            <div class="col-sm-6 form-group">
                                                <label>Receptionist Id</label>
                                                <form:input class="form-control"  type="number" readonly="true"  path="rid" required="true"></form:input>
                                                </div>
                                        </c:if>
                                        <div class="col-sm-6 form-group">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <c:if test="${check}">
                                                <form:button id="editreceptionistbutton" type="submit" name="Addreceptionist"
                                                             class="btn">Save</form:button>
                                            </c:if>
                                            <c:if test="${!check}">
                                                <form:button id="editreceptionistbutton" type="submit" name="EditReceptionist"

...
<html lang="en">
    ...
    <head>
        ...
        <script>
            var room = ${roommodelobject};
            console.log(room);
            angular.module('myapp', []).controller('RoomController',
                    function ($scope) {
                        $scope.Room = room;
                    });
        </script>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-primary" href="bedlist"> <i class="fa fa-list"></i>  Bed List</a>  
                                    </div>
                                </div>
                                <div class="panel-body">

                                    <form:form class="col-sm-6" name="addRoomObject"
                                               modelAttribute="addRoomObject1" action="addingroom"
                                               method="post">
                                        <div class="form-group">
                                            <label>Bed Id</label>
                                            <form:input class="form-control" readonly="true"
                                                        Placeholder="Bed Id" type="text" path="roomid" required="true"></form:input>
                                            </div>
                                            <div class="form-group">
                                                <label>Bed Number</label>
                                            <form:input class="form-control"
                                                        Placeholder="Bed Number" type="text" path="roomnumber" required="true"></form:input>
                                            </div>
                                            <div class="form-group">
                                                <label>Bed Type</label>
                                            <form:input class="form-control"
                                                        Placeholder="Bed Type" type="text" path="roomtype" required="true"></form:input>
                                            </div>

                                            <div class="form-group">
                                                <label>Bed Cost</label>
                                            <form:input type="number" class="form-control"
                                                        placeholder="Bed Cost" path="roomcost" required="true"></form:input>
                                            </div>
                                            <div class="form-check">
                                                <label>Status</label><br>
                                                <label class="radio-inline">
                                                <form:radiobutton path="status" checked="checked" value="Available"/>Available </label> 
                                            <label class="radio-inline"><form:radiobutton path="status" value="Unavailable"/>Unavailable</label>
                                        </div>  
                                        <c:if test="${check}">
                                            <div class="reset-button">
                                                <form:button id="editbuttons" type="submit" name="Addroom"
                                                             class="btn">Add Room</form:button>
                                            </c:if>
                                            <c:if test="${!check}">
                                                <div class="reset-button">
                                                    <form:button id="editbuttons" type="submit" name="EditRoom"
                                                                 class="btn">Edit Room</form:button>
                                                </c:if>

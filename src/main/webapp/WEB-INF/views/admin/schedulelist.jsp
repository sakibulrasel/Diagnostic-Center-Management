                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="addtimeschedule"> <i class="fa fa-plus"></i>  Add Schedule</a>  
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive" >
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="Ts in Timeschedules| filter:test">
                                                    <td><input type="radio" name="radioGroup">
                                                        <label>{{Ts.tid}}</label>   
                                                    </td>
                                                    <td>{{Ts.doctorid}}</td>
                                                    <td>{{Ts.dayoff}}</td>
                                                    <td ><span class="glyphicon glyphicon-time"></span>  {{Ts.starttime}}</td>
                                                    <td><span class="glyphicon glyphicon-time"></span>  {{Ts.endtime}}</td>

                                                    <td>{{Ts.patientlimit}}</td>


                                                    <td>
                                                        <a href="edittimeschedulebutton?gettid={{Ts.tid}}"><button class="btn btn-info btn-xs" id="editbuttons"
                                                                                                                   type="submit"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
                                                        <a href="removetimeschedule/{{Ts.tid}}"><button class="btn btn-danger btn-xs" id="removebuttons"
                                                                                                        type="button"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                    </td>
                                                </tr>

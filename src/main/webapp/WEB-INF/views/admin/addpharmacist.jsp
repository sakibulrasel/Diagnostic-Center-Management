...
<html lang="en">
    ...
    <head>
        ...
        <script>
            var ph = ${pharmacistmodelobject};
           

            console.log(ph);

            angular.module('myApp', []).controller('PharmacistController',
                    function ($scope) {
                        $scope.Pharmacist = ph;
                        
                        console.log($scope.Pharmacist);
                    });
        </script>
        <style type="text/css">
    ...
    <body class="hold-transition sidebar-mini" ng-app="myApp" ng-controller="PharmacistController">        
        <!-- Site wrapper -->
        <div class="wrapper">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-primary" href="pharmacist"> <i class="fa fa-list"></i>  Laboratorist List </a>  
                                    </div>
                                </div>
                                <div class="panel-body">

                                    <form:form class="col-sm-12" name="addPharmacistObject"
                                               modelAttribute="addPharmacistObject1" action="addingpharmacist"
                                               method="post" enctype="multipart/form-data">
                                        
                                        <c:if test="${!check}">
                                            <div class="col-sm-6 form-group">
                                                <label>Pharmacist Id</label>
                                                <form:input class="form-control"  type="number" readonly="true"  path="phid" required="true"></form:input>
                                                </div>
                                        </c:if>
                                        <div class="col-sm-6 form-group">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <c:if test="${check}">
                                                <form:button id="editpharmacistbutton" type="submit" name="Addpharmacist"
                                                             class="btn">Save</form:button>
                                            </c:if>
                                            <c:if test="${!check}">
                                                <form:button id="editpharmacistbutton" type="submit" name="EditPharmacist"

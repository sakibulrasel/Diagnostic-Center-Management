...
#editbuttons:HOVER {
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="addtest"> <i class="fa fa-plus"></i>  Add Test</a>  
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive" >
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="t in Test| filter:test">
                                                    <td><input type="radio" name="radioGroup">
                                                        <label>{{t.testid}}</label>   
                                                    </td>
                                                    ...
                                                    <td>{{t.testcost}}</td>
                                                    <td>
                                                        <a href="edittestbutton?getdeptid={{t.testid}}"><button id="editbuttons" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
                                                        <a href="removetest/{{t.testid}}"><button class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                    </td>
                                                </tr>
    ...
    <!-- Mirrored from healthadmin.thememinister.com/pt-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Sep 2017 19:43:31 GMT -->
</html>
...
#editbuttons:HOVER {
    ...
    <body class="hold-transition sidebar-mini" ng-app="myapp" ng-controller="TestController" >
        <!-- Site wrapper -->
        <div class="wrapper">
                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="btn-group"> 
                                <a class="btn btn-primary" href="testlist"> <i class="fa fa-list"></i>  Test List</a>  
                            </div>
                        </div>
                        <div class="panel-body">
                         
                            <form:form class="col-sm-6" name="addTestObject"
                                       modelAttribute="addTestObject1" action="addingtest"
                                       method="post">
                                <c:if test="${!check}">
                                <div class="form-group">
                                    <label>Test Id</label>
                                    <form:input class="form-control"
                                                 readonly="true" type="number" path="testid" required="true"></form:input>
                                </div>
                                </c:if>
                                ...
                                <div class="form-group">
                                    ...
                                    <form:input class="form-control"
                                                Placeholder="Test Name" type="text" path="testname" required="true"></form:input>
                                </div>
                                <div class="form-group">
                                                <label>Test Type</label>
                                                <select class="form-control" ng-model="selectedTest" ng-options="x.typename for x in Testtype"></select>
                                            </div>

                                        <form:hidden  class="form-control" value="{{selectedTest.typeid}}" path="typeid"></form:hidden>

                                <div class="form-group">
                                    <label>Test Cost</label>
                                    <form:input class="form-control"
                                                Placeholder="Test cost" type="number" path="testcost" required="true"></form:input>
                                </div>
                                
                                  <c:if test="${check}">
                                  <div class="reset-button">
                                      <form:button id="editbuttons" type="submit" name="Addtest"
                                             class="btn">Save</form:button>
                                  </c:if>
                                             <c:if test="${!check}">
                                  <div class="reset-button">
                                      <form:button id="editbuttons" type="submit" name="EditTest"

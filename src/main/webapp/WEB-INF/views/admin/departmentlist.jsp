...
<html lang="en">
    ...
    <body class="hold-transition sidebar-mini" ng-app="myapp"
          ng-controller="DepartmentController">
        <!-- Site wrapper -->
        <div class="wrapper">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    ...
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="adddepartment"> <i class="fa fa-plus"></i>  Add Department</a>  
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="Dept in Department| filter:test" >
                                                    <td><input type="radio" name="radioGroup">
                                                        <label>{{Dept.deptid}}</label>   
                                                    </td>
                                                    <td>{{Dept.deptname}}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="editdepartmentbutton?getdeptid={{Dept.deptid}}"><button id="editbuttons"
                                                                                                                         type="submit" class="btn"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
                                                        <a
                                                            href="removedepartment/{{Dept.deptid}}"><button  id="removebuttons"
                                                                                                         type="button" class="btn"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>

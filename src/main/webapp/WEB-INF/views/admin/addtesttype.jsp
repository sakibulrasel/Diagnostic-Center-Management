                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="btn-group"> 
                                <a class="btn btn-primary" href="testtypelist"> <i class="fa fa-list"></i>  Test Type List</a>  
                            </div>
                        </div>
                        <div class="panel-body">
                         
                            <form:form class="col-sm-6" name="addTesttypeObject"
                                       modelAttribute="addTesttypeObject1" action="addingtesttype"
                                       method="post">
                                <c:if test="${!check}">
                                <div class="form-group">
                                    <label>Type Id</label>
                                    <form:input class="form-control"
                                                 readonly="true" type="number" path="typeid" required="true"></form:input>
                                </div>
                                </c:if>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="reset-button">
                                      <form:button id="editbuttons" type="submit" name="Addtesttype"
                                             class="btn">Save</form:button>
                                  </c:if>
                                             <c:if test="${!check}">
                                  <div class="reset-button">
                                      <form:button id="editbuttons" type="submit" name="EditTesttype"

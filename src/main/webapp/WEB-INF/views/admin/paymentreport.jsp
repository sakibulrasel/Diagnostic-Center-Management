<%-- 
    ...
    Created on : Dec 27, 2018, 3:00:32 PM
    Author     : sakib
--%>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form:form class="col-sm-6" method="POST" action="paymentreportView" commandName="reportInputForm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="reset-button">
                                                <form:button id="editbuttons" type="submit" 
                                                 ...
                                                 <form:button class="btn btn-warning" type="reset" 
                                                             >Reset</form:button>

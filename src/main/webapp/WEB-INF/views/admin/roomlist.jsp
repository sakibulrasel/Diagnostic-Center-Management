...
<html lang="en">
    ...
    <head>
        ...
        =====================================================================-->
        <!-- jquery-ui css -->
        <link href="vassets/plugins/jquery-ui-1.12.1/jquery-ui.min.css" rel="stylesheet" type="text/css"/>
        <!-- Bootstrap -->
    ...
    <body class="hold-transition sidebar-mini" ng-app="myapp" ng-controller="RoomController">
        <!-- Site wrapper -->
        <div class="wrapper">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                <div class="panel-heading">
                                    <div class="btn-group"> 
                                        <a class="btn btn-success" href="addbed"> <i class="fa fa-plus"></i>  Add Bed</a>  
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive" >
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="Rr in Room| filter:test">
                                                    <td>
                                                        <input type="radio" name="radioGroup">
                                                        <label>{{Rr.roomid}}</label>   
                                                    </td>
                                                    <td>{{Rr.roomnumber}}</td>
                                                    <td>{{Rr.roomtype}}</td>
                                                    <td>{{Rr.roomcost}}</td>
                                                    ...
                                                    <td>
                                                        <a href="editroombutton?getroomid={{Rr.roomid}}"><button id="editbuttons" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
                                                        <a href="removeroom/{{Rr.roomid}}"><button class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                    </td>
                                                </tr>

...
INSERT INTO `addmission` (`addid`,`roomid`,`pid`,`addmissiondate`,`numberofday`,`description`,`cost`,`pname`,`roomtype`,`status`,`totalcost`) VALUES 
 (1,1,1,'2018-12-13',4,'asdfasdfasdfasdfasdfasdf',50000,NULL,'Non-AC,sakibul','Available',0),
 (2,1,2,'2018-12-13',5,'asfd',50000,'sakibul','Non-AC','Available',250000),
 (3,1,2,'2018-12-15',5,'asdfasdfasdfasdfasdfasdf',50000,'sakibul','Non-AC','Available',250000);
...
INSERT INTO `appointments` (`appointid`,`pid`,`doctorid`,`appointdate`,`appointstatus`,`problem`,`deptname`,`fees`,`billstatus`) VALUES 
 (1,5,1,'2018-12-22','Ok','dasd','Neorology',600,'');
...
CREATE TABLE `paymentinfo` (
  ...
  `presid` int(10) unsigned default '0',
  `addid` int(10) unsigned default '0',
...
INSERT INTO `paymentinfo` (`pid`,`presid`,`addid`,`appointfees`,`paymentdate`,`status`,`admissionfees`,`testcost`,`total`) VALUES 
 (1,0,0,0,NULL,'Pending',0,5000,5700),
 (2,0,0,0,NULL,'Pending',250000,5000,0),
 (5,0,0,500,NULL,'Pending',0,0,0);
...
INSERT INTO `prescription` (`presid`,`doctorid`,`pid`,`presdate`,`nextconsultdate`,`remarks`,`appointid`) VALUES 
 (2,1,5,'2018-12-15','2018-12-22','adsfasdf',1),
 (3,1,5,'2018-12-15','2018-12-22','asdfadf',1),
 (4,1,5,'2018-12-13','2018-12-29','asd',1),
 (5,1,5,'2018-12-05','2018-12-28','adf',1),
 (6,1,5,'2018-12-13','2018-12-08','asdfadf',1);
...
INSERT INTO `prescriptiondrug` (`drugid`,`presid`,`listid`,`dose`,`doseschedule`,`doseadvice`,`groupid`,`typeid`,`appointid`,`doctorid`,`pid`) VALUES 
 ...
 (3,3,1,'3','Morning, evening, Night','laksfa',2,2,1,1,5),
 (4,0,0,NULL,NULL,NULL,0,0,1,1,5),
 (5,0,0,NULL,NULL,NULL,0,0,1,1,5),
 (6,0,1,'3','Morning, evening, Night','laksfa',2,2,1,1,5),
 (7,0,2,'3','Morning, evening, Night','laksfa',3,2,1,1,5),
 (8,6,1,'3','Morning, evening, Night','laksfa',2,2,1,1,5),
 (9,6,2,'3','Morning, evening, Night','laksfa',3,2,1,1,5);
...
INSERT INTO `testreport` (`reportid`,`presid`,`testid`,`testdate`,`reportdate`,`report`,`pid`) VALUES 
 (2,2,1,'2018-12-12','2018-12-21','adfadf',NULL),
 (4,2,1,'2018-12-11','2018-12-12','asdfasddf',NULL),
 (5,2,1,'2018-12-11','2018-12-12','asdf',NULL),
 (6,2,1,'2018-12-11','2018-12-13','asdfasdf',NULL),
